...
class AIRL(PPO):
    ...
    def __init__(self, buffer_exp, state_shape, action_shape, device, seed,
                 ...
                 coef_ent=0.0, max_grad_norm=10.0, weighted=False, state_only=False):
        super().__init__(
            state_shape, action_shape, device, seed, gamma, rollout_length,
            mix_buffer, lr_actor, lr_critic, units_actor, units_critic,
            epoch_ppo, clip_eps, lambd, coef_ent, max_grad_norm, weighted, state_only
        )
        # Expert's buffer.
    ...
    def update_disc(self, states, actions, dones, log_pis, next_states, states_exp, actions_exp, dones_exp, log_pis_exp, next_states_exp, writer):
